...
function [simInit, T] = initAllSimParams_catenary(ENVMT, simInit, T)
%initAllSimParams_catenary - Update parameters to fit test case
%
% Inputs:
...
%
% Example:  [simInit, T] = initAllSimParams_catenary(ENVMT, simInit, T)
%
...
simInit.TSIM = 1; % Simulation Time 
simInit.dt= 0.005; % Step size

simInit.pos_W_init =  [100;100;300];
...
T.tether_inital_lenght = norm( simInit.pos_O_init)+100;
...
%% Catenary curve
[simInit.x_catenary,simInit.y_catenary,simInit.z_catenary] = solve_cat([0;0;0],simInit.pos_W_init,T.tether_inital_lenght);
%------------- END CODE --------------
end