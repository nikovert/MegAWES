...
function [simInit,T] = initAllSimParams_tether_fall2(ENVMT, simInit,T)
%initAllSimParams_tether_fall2 - Update parameters to fit test case
%
% Inputs:
...
%
% Example:  [simInit, T] = initAllSimParams_tether_fall2(ENVMT, simInit, T)
%
...
simInit.Pulling_Force = 0;

simInit.TSIM = 100; % Simulation Time 
